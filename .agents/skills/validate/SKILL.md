---
name: validate
description: Use when a technical design needs quality review before implementation. It checks the design for critical issues, readiness, and missing decisions, and returns concise validation feedback rather than writing code.
...
- Re-validate with `/validate {feature}`
