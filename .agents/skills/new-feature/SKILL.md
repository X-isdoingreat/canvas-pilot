---
name: new-feature
description: Use when a product idea needs a quick implementation spec before coding. It can run interactively or automatically to generate focused requirements and design notes, without changing code by itself.
...
Skipped: /kiro-validate-gap, /validate

Sanity review: PASSED | FOLLOW-UP REQUIRED

Next Steps:
1. Review generated specs (especially design.md)
2. Optional: `/kiro-validate-gap {feature}`, `/validate {feature}`
