...
Used by the Codex bootstrap and canvas-generic skills when creating, loading,
and updating an optional per-cluster learnings overlay.  The shared helper
prevents bootstrap-time and runtime paths from drifting apart.
"""
