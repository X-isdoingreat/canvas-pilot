...
Shared by canvas-humanizer and canvas-humanizer-loop so both use bit-identical
splitter behavior.  This is load-bearing for the loop's structural-drift check
because paragraph segment counts must stay stable across iterations.
"""
