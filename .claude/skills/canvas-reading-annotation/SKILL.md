...
{
  "course_id": "<id>",
  "skill_name": "reading-annotation",
  "kind": "<resolved kind>",
  "sources": {
    "yuja_transcript": {"enforcement": "mandatory", "status": "loaded", "path": "sources/<Slug>.txt"},
    "reading_pdf":     {"enforcement": "mandatory", "status": "loaded", "path": "sources/Reading_N.pdf"}
  }
}
```
