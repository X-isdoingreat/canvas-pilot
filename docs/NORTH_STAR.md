...
> ⚠️ **SUPERSEDED (2026-06-13) for product architecture/features** → see
> [`docs/PRODUCT_SPEC.md`](./PRODUCT_SPEC.md), the single source of truth for
> what the product is, how it runs, and its capabilities (Codex-primary).
> This file is kept for trajectory/history. Where the two differ, PRODUCT_SPEC wins.
