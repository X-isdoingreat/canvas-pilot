...
def main() -> int:
    run("tests/codex_runtime/run_skill_frontmatter_tests.py")
    run("tests/codex_runtime/run_setup_tests.py")
    run("tests/codex_runtime/run_opportunity_tests.py")
    run("tests/codex_runtime/run_daily_work_tweet_tests.py")
